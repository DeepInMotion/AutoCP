...
class Activations:
    ...
    def get_activation(activation_str: str, module_name: str):
        ...
        if activation_str == "relu":
            ...
            return Swish(module_name, inplace=False)
        elif activation_str == 'acon':
            return AconC(channel=8)  # You should also update AconC to include module_name if needed
        elif activation_str == 'meta':
            return MetaAconC(channel=8)  # Same for MetaAconC
        else:
